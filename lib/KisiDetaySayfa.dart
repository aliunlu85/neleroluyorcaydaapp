...
class _KisiDetaySayfaState extends State<KisiDetaySayfa> {
  ...
  Future<void> guncelle(String kisi_id,String kisi_ad,String kisi_yas) async {
    print("$kisi_ad - $kisi_yas güncellendi");
    Navigator.push(context, MaterialPageRoute(builder: (context) => Fire1()));
  }
